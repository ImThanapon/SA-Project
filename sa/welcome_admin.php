                    ...
                    <table class="table table-striped">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr style="font-size: large;">
                                ...
                                <td><?php echo ('-');?></td>
                                <?php }else{ ?>
                                <td><?php echo substr($row['id_card'], 0, 1);?>-<?php echo substr($row['id_card'], 1, 4);?>-XXXXX-<?php echo substr($row['id_card'], -3);?>
                                </td>
                                <?php } ?>
                                <?php
                                if(empty($row['phone'])){ ?>
                                <td><?php echo ('-');?></td>
                                <?php }else{ ?>
                                <td><?php echo substr($row['phone'], 0, 3);?>-XXX-<?php echo substr($row['phone'], 6, 10);?>
                                </td>
                                <?php } ?>
                                ...
                                <td>
                                    <?php
                                    if(($row['check_in'])=='0000-00-00'){
                                        ?>
                                    <a href="register.php?room_id=<?php echo $row['room_id']; ?>"
                                    ...
                                    <!-- <a href="#" class="btn btn-danger" data-toggle="modal"
                                        data-target="#logoutModal">ลบ</a>
                                    <div class="modal fade" id="logoutModal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h3 class="modal-title">ลบบัญชีผู้พักอาศัย</h3>
                                                </div>
                                                <div class="modal-body">
                                                    <h5 class="">คุณต้องการลบบัญชี
