<?php 
    ...
    class DB_con {
        ...
        public function getData() {
            ...
            FROM users 
            -- INNER JOIN rooms 
            -- ON users.room_id = rooms.room_id 
        ...
        public function getDetail($room) {
            ...
            FROM invoices 
            -- INNER JOIN receipts 
            -- ON invoices.room_id = receipts.room_id 
        ...
        public function registration($name, $line, $phone, $email, $username, $password, $img_profile, $room, $check_in, $address, $id_card) {
           ...
           "
            ...
            // $reg_room = mysqli_query($this->dbcon, 
            // "INSERT INTO rooms (room_id, check_in) 
            // VALUES ('$room', '$check_in') ");
            
            // mysqli_query($this->dbcon, "INSERT INTO rooms (name, phone, email, username, password, image) VALUES('$name', '$phone','$email', '$username', '$password', '$img_profile')");
            if($reg_info){
                return $reg_info;
            }else{
        ...
        //     $reg_info = mysqli_query($this->dbcon, 
        //     "INSERT INTO users (name, room_id, phone, line, email, address, id_card, username, password, image) 
        //     VALUES ('$name', '$room', '$phone', '$line', '$email', '$address', '$id_card', '$username', '$password', '$img_profile')");
        //     if($reg_info){
        //         return $reg_info;
        //     }else{
        //         echo "<script>alert('เกิดข้อผิดพลาด ระหว่างส่งข้อมูล !!');</script>";
        ...
        public function signin($username, $password) {
            ...
            // ON users.room_id = rooms.room_id 
            // INNER JOIN invoices 
            // ON rooms.room_id = invoices.room_id 
            // -- INNER JOIN receipts 
        ...
        public function member_detail($username, $password) {
